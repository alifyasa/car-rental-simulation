...
#define DD_RIDX_OFFSET 2 // RIDX_PERSON_DD_X = LOCN_x + DD_RIDX_OFFSET
#define RIDX_PERSON_DD_FROM_AIR_TERMINAL_1 3
#define RIDX_PERSON_DD_FROM_AIR_TERMINAL_2 4
#define RIDX_PERSON_DD_FROM_CAR_RENTAL 5
#define RIDX_PERSON_ARRIVAL_LOCN 6
